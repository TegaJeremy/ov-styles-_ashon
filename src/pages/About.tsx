    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[75vh] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <h1 className="font-display text-6xl md:text-9xl text-white font-light tracking-wider leading-none">
            {t.ourStory}
          </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                ...
                <h2 className="font-display text-4xl md:text-5xl font-light mt-3 text-foreground leading-tight">
                  {t.craftingElegance}
                </h2>
                <div className="w-12 h-[1px] bg-accent mt-6 mb-8" />
                <p className="text-muted-foreground font-body leading-relaxed mb-5 text-base">
                  {t.visionP1}
                </p>
                ...
                <div className="grid grid-cols-3 gap-6 pt-6 border-t border-border">
                  {[
                    ...
                    <div key={i} className="text-center group cursor-default">
                      <div className="font-display text-3xl text-accent font-light group-hover:scale-110 transition-transform duration-300 inline-block">
                        {s.n}
                      </div>
                      <div className="text-[10px] tracking-widest text-muted-foreground uppercase font-body mt-1">
                        {s.l}
                      </div>
                    </div>
                  ))}
              ...
              {/* another.jpeg as the vision image */}
        ...
        <section className="animate-section py-28 bg-secondary/20">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-4xl md:text-6xl font-light mt-3 text-foreground">
                {t.philosophyHeading}
              </h2>
            ...
            <div className="mt-20 border-l-4 border-accent pl-8 max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground font-body text-xs mt-4 tracking-[0.3em] uppercase">
                {t.founderQuoteAttr}
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
              ...
              <div className="lg:pt-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-accent text-[10px] font-body tracking-[0.4em] uppercase">
                    {t.ceoTitle}
                  </span>
                </div>
                <h3 className="font-display text-3xl font-light text-foreground mb-1">
                  {t.codeAndCouture}
                </h3>
                <p className="text-[10px] tracking-[0.3em] uppercase text-muted-foreground font-body mb-8">
                  {t.ceoSubtitle}
                </p>

                <p className="text-muted-foreground font-body leading-relaxed mb-5 text-sm">
                  {t.directorFullBio1}
                </p>
                <p className="text-muted-foreground font-body leading-relaxed mb-5 text-sm">
                  {t.directorFullBio2}
                </p>
                <p className="font-body leading-relaxed mb-8 text-sm text-foreground/80 font-medium">
                  {t.directorFullBio3}
                </p>
                  ...
                  {[
                    {
                      ...
                      title: t.tagHauteCouture,
                      desc: "Bespoke garment construction and atelier direction",
                    },
                    {
                      icon: <Code2 size={14} />,
                      title: t.tagTechDesign,
                      desc: "Backend engineering applied to creative operations",
                    },
                    {
                      icon: <Sparkles size={14} />,
                      title: t.tagAfricanLuxury,
                      desc: "African textile heritage and luxury brand positioning",
                    },
                    {
                      icon: <Globe size={14} />,
                      title: "Global Reach",
                      desc: "Clients across Nigeria, the diaspora and beyond",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-4 p-4 border border-border hover:border-accent/40 transition-all duration-300 group"
                    >
                      <span className="text-accent mt-0.5 shrink-0 group-hover:scale-110 transition-transform duration-300">
                        {item.icon}
                      </span>
                      <div>
                        <p className="text-foreground font-body text-xs tracking-[0.2em] uppercase font-medium">
                          {item.title}
                        </p>
                        <p className="text-muted-foreground font-body text-xs mt-0.5 leading-relaxed">
                          {item.desc}
                        </p>
                      </div>
                    </div>
              ...
              {milestoneKeys.map((key, i) => (
                <div key={i} className="flex gap-8 mb-10 group">
                  <div className="flex flex-col items-center">
                    ...
                    {i < milestoneKeys.length - 1 && (
                      <div className="w-[1px] flex-1 bg-border mt-2" />
                    )}
                  </div>
                  <div className="pb-8">
                    <span className="font-display text-2xl text-accent font-light">
                      {milestoneYears[i]}
                    </span>
                    <p className="text-muted-foreground font-body mt-1 leading-relaxed text-sm">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                ...
                <div
                  key={i}
                  className="text-center group p-10 border border-border hover:border-accent/40 transition-all duration-300"
                >
        ...
        <section className="animate-section relative py-40 overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <Link
                to="/marketplace"
                className="inline-block px-12 py-4 bg-accent text-accent-foreground text-xs font-body tracking-[0.3em] uppercase hover:bg-accent/90 transition-all duration-300"
              >
                {t.shopCollection}
              </Link>
              <Link
                to="/contact"
                className="inline-block px-12 py-4 border border-white/40 text-white text-xs font-body tracking-[0.3em] uppercase hover:bg-white/10 transition-all duration-300"
              >
                {t.getInTouch}
              </Link>
            </div>
